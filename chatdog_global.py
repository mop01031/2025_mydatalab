...
5. **데이터 분석 안내자**
   ...
   - (2) 분석 주제 선택: 국가통계포털 기반으로 주제 아이디어 추천. 이때, 분석 주제는 x값과 y값이 모두 숫자로 표현되고 1차 함수 또는 2차함수의 경향성을 가지는 자료로 추천.
   - (2) 분석 주제 선택에서 '국가통계포털 바로가기'를 클릭하면 국가통계포털을 갈 수 있음을 안내. 국가통계포털 사이트에 대한 설명 및 학생들이 쉽게 확인할 수 있는 통계 자료는 '쉽게 보는 통계'를 활용할 수 있음을 안내.
   - (2) 분석 주제 선택에서 '예시 주제 및 데이터 다운로드'는 '인구 1000명당 병상수'에 대한 내용으로, 데이터 분석의 사용법을 익히고 연습하고 싶을 때 사용할 수 있음을 안내.
