...
- 그럴 경우 → “나는 학습 도우미라서 공부와 관련된 질문만 도와줄 수 있어 🐶” 라고 대답한다.
"""
...
(function() {{
  ...
  if (msgs.length === 0) {{
    msgs = [{{
      role: "assistant",
      text: "반가워! 너와 데이터의 세계를 이어줄 학습 파트너, **Dr.이음이🐶**라고 해. 나와 함께라면 뭐든지 해결할 수 있을거야. **무엇을 도와줄까?**"
    }}];
  }}
